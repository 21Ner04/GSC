          ...
          <div className="min-w-0">
            ...
            <div className="card-stable space-y-6 rounded-2xl bg-muted p-5 sm:space-y-8 sm:rounded-3xl sm:p-8">
              <div>
                ...
                <p className="mt-2 text-sm text-muted-foreground">Serving NY, NJ, FL, PA</p>
              </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="min-w-0">
                    <p className="font-medium text-foreground">
                      <a href="tel:7186154545" className="hover:text-primary">
                        Office: 718-615-4545
                      </a>
                    </p>
                    <p className="font-medium text-foreground">
                      <a href="tel:8556154545" className="hover:text-primary">
                        Toll Free: 855-615-4545
                      </a>
                    </p>
                    <p className="mt-1 text-sm text-muted-foreground">Fax: 718-819-1127</p>
                  </div>
                </div>
                <div className="flex items-start">
              ...
              <div className="space-y-4 border-t border-gray-200 pt-6">
                ...
                <div className="flex flex-wrap gap-2.5 sm:gap-3">
                  {(
                    [
                      [
                        "https://www.instagram.com/gsc.mortgage",
                        Instagram,
                        "Instagram",
                      ],
                      [
                        "https://www.facebook.com/greenstreetcapital",
                        Facebook,
                        "Facebook",
                      ],
                      ["https://twitter.com/greenstreetcap", Twitter, "Twitter"],
                      [
                        "https://www.linkedin.com/company/green-street-capital",
                        Linkedin,
                        "LinkedIn",
                      ],
                      ["https://www.youtube.com/@GSC.MORTGAGE", Youtube, "YouTube"],
                    ] as const
                  ).map(([href, Icon, label]) => (
                    <a
                      key={label}
                  ...
                  <a
                    href="https://www.tiktok.com/@gsc.mortgage"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-white text-foreground shadow-sm transition-colors hover:bg-accent hover:text-white"
                    aria-label="TikTok"
            ...
            <div className="mt-6 grid grid-cols-1 gap-3 sm:mt-8 sm:grid-cols-2 sm:gap-4">
              <Link href="/team" className="block w-full">
                <Button className="w-full">Book Time with Team</Button>
              </Link>
              <Link href="/team" className="block w-full">
          ...
          <div className="min-w-0 space-y-6 sm:space-y-8">
            ...
            <div className="space-y-2">
              ...
              <p className="break-anywhere text-center text-xs text-muted-foreground sm:text-sm">
                Green Street Capital, LLC — 2709 Coney Island Ave, 3rd Floor, Brooklyn, NY 11235
              </p>
            </div>
          </div>
        </div>
